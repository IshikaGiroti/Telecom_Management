...
system("cls");
    ...
    printf("\n\n\n\n\n\n\n\n\t\t  -----------------------------------------------------------------\n");
    printf("\t\t |                                                                 |\n");
    printf("\t\t |               TELECOM BILLING MANAGEMENT SYSTEM                 |\n");
    printf("\t\t |                                                                 |\n");
    printf("\t\t  -----------------------------------------------------------------");
...
system("cls");
   printf("\n   -----------------------------------------------------------------");
    printf("\n  | Enter any of the following alphabets:                           |\n");
    printf("   -----------------------------------------------------------------");
    printf("\n  | A/a : Adding new records                                        |");
    printf("\n  | P/p : Processing payment                                        |");
    printf("\n  | M/m : Updating/Modifying current records                        |");
    printf("\n  | S/s : Searching records                                         |");
    printf("\n  | L/l : Listing current records                                   |");
    printf("\n  | D/d : Deleting records.                                         |");
    printf("\n  | E/e : Closing the program                                       |");
    printf("\n   -----------------------------------------------------------------\n\n");
...
void listrecords()
{
    ...
    {
        printf("\n%s\t\t%s\t\t\tRs. %f /-",s.phonenumber,s.name,s.amount);
    }
    printf("\n");
    for(i=0;i<79;i++)
        printf("-");
...
modiop(char oldName[],char newName[])
{
